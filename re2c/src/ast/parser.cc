...
#line 1 "./src/ast/parser.ypp" /* yacc.c:338  */
...
#line 103 "src/ast/parser.cc" /* yacc.c:338  */
# ifndef YY_NULLPTR
...
/* In a future release of Bison, this section will be replaced
   by #include "y.tab.h".  */
#ifndef YY_YY_SRC_AST_Y_TAB_H_INCLUDED
# define YY_YY_SRC_AST_Y_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
union YYSTYPE
{
#line 40 "./src/ast/parser.ypp" /* yacc.c:353  */
...
#line 166 "src/ast/parser.cc" /* yacc.c:353  */
};
...
#endif /* !YY_YY_SRC_AST_Y_TAB_H_INCLUDED  */
...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, re2c::context_t &context)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (context);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, re2c::context_t &context)
{
  YYFPRINTF (yyo, "%s %s (",
...
yyreduce:
  ...
  switch (yyn)
    {
        case 3:
#line 69 "./src/ast/parser.ypp" /* yacc.c:1645  */
    { context.input.lex_conf(context.opts); }
#line 1296 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 7:
#line 76 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
...
#line 1307 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 8:
#line 83 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        fatal_l(context.input.get_cline(),
            "trailing contexts are not allowed in named definitions");
    }
#line 1316 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 9:
#line 89 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        (yyval.str) = (yyvsp[-1].str);
    }
#line 1324 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 10:
#line 92 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        (yyval.str) = (yyvsp[0].str);
    }
#line 1332 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 13:
#line 99 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        find(context.specs, "").rules.push_back(ASTRule((yyvsp[-1].regexp), (yyvsp[0].code)));
    }
#line 1340 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 14:
#line 103 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        find(context.specs, "").defs.push_back((yyvsp[0].code));
    }
#line 1348 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 15:
#line 107 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
...
#line 1359 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 16:
#line 114 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        for(CondList::const_iterator i = (yyvsp[-3].clist)->begin(); i != (yyvsp[-3].clist)->end(); ++i) {
...
#line 1370 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 17:
#line 121 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
...
#line 1381 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 18:
#line 128 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        const AST *r = ast_nil(context.input.get_cline(), 0);
        find(context.specs, "0").rules.push_back(ASTRule(r, (yyvsp[0].code)));
    }
#line 1390 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 20:
#line 136 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        (yyval.code) = (yyvsp[0].code);
        (yyval.code)->cond = *(yyvsp[-1].str);
        delete (yyvsp[-1].str);
    }
#line 1400 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 21:
#line 142 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        (yyval.code) = new Code(context.input.get_fname(), context.input.get_cline());
        (yyval.code)->cond = *(yyvsp[0].str);
        delete (yyvsp[0].str);
    }
#line 1410 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 23:
#line 150 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        (yyval.clist) = new CondList;
        (yyval.clist)->insert("*");
    }
#line 1419 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 24:
#line 156 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        (yyval.clist) = new CondList;
        (yyval.clist)->insert(*(yyvsp[0].str));
        delete (yyvsp[0].str);
    }
#line 1429 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 25:
#line 162 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        (yyvsp[-2].clist)->insert(*(yyvsp[0].str));
        delete (yyvsp[0].str);
        (yyval.clist) = (yyvsp[-2].clist);
    }
#line 1439 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 26:
#line 169 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        (yyval.regexp) = ast_cap((yyvsp[0].regexp));
    }
#line 1447 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 27:
#line 171 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        (yyval.regexp) = ast_cat(ast_cap((yyvsp[-2].regexp)),
            ast_cat(ast_tag(context.input.get_cline(), 0, NULL, false), (yyvsp[0].regexp)));
    }
#line 1456 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 28:
#line 178 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
            (yyval.regexp) = (yyvsp[0].regexp);
        }
#line 1464 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 29:
#line 182 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
            (yyval.regexp) = ast_alt((yyvsp[-2].regexp), (yyvsp[0].regexp));
        }
#line 1472 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 30:
#line 189 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
            (yyval.regexp) = (yyvsp[0].regexp);
        }
#line 1480 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 31:
#line 193 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
            (yyval.regexp) = ast_diff((yyvsp[-2].regexp), (yyvsp[0].regexp));
        }
#line 1488 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 32:
#line 200 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
            (yyval.regexp) = (yyvsp[0].regexp);
        }
#line 1496 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 33:
#line 204 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
            (yyval.regexp) = ast_cat((yyvsp[-1].regexp), (yyvsp[0].regexp));
        }
#line 1504 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 35:
#line 211 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        switch((yyvsp[0].op)) {
...
#line 1516 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 36:
#line 217 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        (yyval.regexp) = ast_iter((yyvsp[-1].regexp), (yyvsp[0].bounds).min, (yyvsp[0].bounds).max);
    }
#line 1524 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 38:
#line 223 "./src/ast/parser.ypp" /* yacc.c:1645  */
    { (yyval.op) = ((yyvsp[-1].op) == (yyvsp[0].op)) ? (yyvsp[-1].op) : '*'; }
#line 1530 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 39:
#line 227 "./src/ast/parser.ypp" /* yacc.c:1645  */
    { (yyval.op) = '*'; }
#line 1536 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 40:
#line 228 "./src/ast/parser.ypp" /* yacc.c:1645  */
    { (yyval.op) = '+'; }
#line 1542 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 41:
#line 229 "./src/ast/parser.ypp" /* yacc.c:1645  */
    { (yyval.op) = '?'; }
#line 1548 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 43:
#line 234 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
...
#line 1565 "src/ast/parser.cc" /* yacc.c:1645  */
    break;

  case 44:
#line 245 "./src/ast/parser.ypp" /* yacc.c:1645  */
    {
        (yyval.regexp) = ast_cap((yyvsp[-1].regexp));
    }
#line 1573 "src/ast/parser.cc" /* yacc.c:1645  */
    break;


#line 1577 "src/ast/parser.cc" /* yacc.c:1645  */
      default: break;
    }
...
#line 249 "./src/ast/parser.ypp" /* yacc.c:1903  */
